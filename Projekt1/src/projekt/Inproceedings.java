package projekt;
/**
 * W tej klasie przechowywane s¹ specyficzne dane dotycz¹ce osobnego typu jakim jest typ Inproceedings. S¹ to pola wymagane i opcjonalne tego typu.
  * @author Karolina Piekarz
 * @see CheckedRecord
 */
public class Inproceedings extends CheckedRecord{
	/**
	 ...
	 * @see CheckedRecord
	 */
	public Inproceedings(Record record) {
		super(record);
